...
carImg = pygame.image.load('C:\\Users\\VENKATESH JACKIE\\OneDrive\\Desktop\\apple.png')
overImg = pygame.image.load('C:\\Users\\VENKATESH JACKIE\\OneDrive\\Desktop\\snake.gif')
welcm = pygame.image.load('C:\\Users\\VENKATESH JACKIE\\OneDrive\\Desktop\\welcome.jpg')
green = (1, 50, 32)
...
def start_game():
    pygame.mixer.music.load('C:\\Users\\VENKATESH JACKIE\\OneDrive\\Desktop\\media.io_background.wav')
    ...
    FPS = 60
    snake_mv = 'r'
    food_pos = (random.randint(1, 800), random.randint(70, 800))
...
with open("C:\\Users\\VENKATESH JACKIE\\OneDrive\\Desktop\\high_score.txt", "r") as f:
    high_score = int(f.read())
# Creating a game loop
sound1 = pygame.mixer.Sound('C:\\Users\\VENKATESH JACKIE\\OneDrive\\Desktop\\bite.wav')
while not exit_game:
    while start_on:
    ...
    if head[-1][0] >= 900 or head[-1][0] <= 1 or head[-1][1] >= 900 or head[-1][1] <= 60 or head[-1] in head[:-1]:
        pygame.mixer.music.load('C:\\Users\\VENKATESH JACKIE\\OneDrive\\Desktop\\bite.wav')
